...
--If you see blocking with LCK_M_S waits, this is probably due to the Clean-up job. 
--This job runs every 10 minutes and it clears the commands that have already been replicated. 
--It is safe to stop and disable the job for a couple of hours to clear the blocking.